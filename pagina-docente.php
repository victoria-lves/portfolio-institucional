...
if (!$id_professor) {
    die("Professor não selecionado. <a href='menu-docentes.php'>Voltar</a>");
}
    ...
    <main>
        ...
        <section class="section-card">
            ...
            <?php if (!empty($prof['lattes'])): ?>
                <p id="lattes">Currículo Lattes: <a href="<?php echo $prof['lattes']; ?>" target="_blank">Acessar Lattes</a>
                </p>
            <?php endif; ?>
